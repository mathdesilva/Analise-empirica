...
int main(){
	...
	// teste jumpSearch
	value1 = jumpSearch(arr, 0, MAXN-1, 2000);
	value2 = jumpSearch(arr, 0, MAXN-1, 2001);
	value3 = jumpSearch(arr, 0, MAXN-1, 0);
	value4 = jumpSearch(arr, 0, MAXN-1, (MAXN-1) * 2);
	std::cout << ">>> jumpSearch\n";
	std::cout << "Value 1 (1000):" << value1 << std::endl;
	std::cout << "Value 2 (-1):" << value2 << std::endl;
	std::cout << "Value 3 (0):" << value3 << std::endl;
	...
	// teste fibonacciSearch
	value1 = fibonacciSearch(arr, 0, MAXN-1, 2000);
	value2 = fibonacciSearch(arr, 0, MAXN-1, 2001);
	value3 = fibonacciSearch(arr, 0, MAXN-1, 0);
	value4 = fibonacciSearch(arr, 0, MAXN-1, (MAXN-1) * 2);
